...
/**
 * Hook to drive the ambient constellation canvas — particles drift continuously, seeded once on
 * mount so viewport jitter doesn't reshuffle them.
 * @returns Canvas ref.
 */
export const useAmbientCanvas = () => {
